      ...
      <div className={styles.educationContainer}>
        ...
        <div className={styles.educationContent}>
          ...
          <p className={styles.educationDescription}>
            ...
            3.90 from ASU. Developed expertise in full-stack development, cloud
            computing, and scalable software solutions. Worked as a Graduate
            Student Assistant, teaching Intro to Programming Languages and Game
            Programming, where I mentored students and enhanced my instructional
            skills. Additionally, contributed to innovative projects like Auto
            BIM Route AI, focusing on automated route planning and optimization.
          </p>
        </div>
      </div>
      ...
      <div className={styles.educationContainer}>
        ...
        <div className={styles.educationContent}>
          ...
          <p className={styles.educationDescription}>
            ...
            structures, and algorithms. Engaged in various projects, coursework,
            and collaborative learning environments that honed my
